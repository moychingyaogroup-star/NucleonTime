...
const VIEW_TITLES={home:'Schedule',categories:'Categories','important-dates':'Important Dates',analytics:'Analytics',friends:'Friends',messages:'Messages',business:'Business',employees:'Employees',profile:'Profile',stories:'Stories',finances:'Finances',news:'News'};
function switchView(view){
  ...
  if(view==='finances' && typeof renderFinances === 'function')renderFinances();
