...
function renderPlant() {
    if (typeof ensureStarterAppleGift === 'function') ensureStarterAppleGift();
    ...
    if (typeof renderStickerStore === 'function') renderStickerStore();
}
...
function waterPlant() {
    ...
    if (state.level >= 6) {
        state.goldenApplesAvailable = Math.min(20, (state.goldenApplesAvailable || 0) + 5);
    }
...
// renderPlant() is called from init() after the app is visible.
